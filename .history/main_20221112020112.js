// alert(
//   '네이버앱, Edge로 접속하시면 동영상이 안 나옵니다. 일부 아이폰은 UI가 제대로 반영되지 않을 수 있습니다. PC나 안드로이드로 접속바랍니다.'
// );
...
function setTransformScale(scaleFactor) {
  ...
  let height = window.style.height * (1 / scaleFactor);
  let width = window.style.width * (1 / scaleFactor);
}
window.addEventListener('resize', () => {
