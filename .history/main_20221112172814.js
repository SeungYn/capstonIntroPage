...
window.addEventListener('DOMContentLoaded', () => {
  const apple = /iphone|ipod|safari/i.test(navigator.userAgent.toLowerCase());
  if (/ippad/i.test(test(navigator.userAgent.toLowerCase()))) {
    alert('ipad');
  }
  if (apple) {
    document.documentElement.style.setProperty('--font-medium', '30px');
  }
